...
**Бекап** — это копия сайта на случай, если что-то сломается. Из неё можно восстановить магазин в том виде, в каком он был на момент копии.
...
![Форма создания резервной копии](images/20.png)
...
![Регулярное резервное копирование](images/23.png)
...
![Список резервных копий](images/22.png)
