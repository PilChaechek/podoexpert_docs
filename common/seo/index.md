...
## Как проверить базовое SEO сайта

Для быстрой проверки можно использовать бесплатные инструменты:

- [Google PageSpeed Insights](https://pagespeed.web.dev/) — скорость загрузки и базовые ошибки
- [Schema Markup Validator](https://validator.schema.org/) — проверка структурированных данных
